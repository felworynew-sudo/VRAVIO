/* @ts-self-types="./vector_text.d.ts" */
 ...
 * @returns {string}
 */
export function layout_text(text, font_size, max_width, script) {
    let deferred3_0;
    let deferred3_1;
    try {
        ...
        const ret = wasm.layout_text(ptr0, len0, font_size, max_width, ptr1, len1);
        deferred3_0 = ret[0];
        deferred3_1 = ret[1];
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('vector_text_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
