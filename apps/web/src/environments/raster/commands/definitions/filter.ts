...
const commands: readonly CommandDefinition[] = [
  ...
  {
    id: "filter.repeatLast",
    label: { en: "Repeat Filter", ru: "Предыдущий фильтр" },
    category: CATEGORY_FILTER,
    shortcut: "Mod+Alt+F",
    surfaces: ["menu", "palette"],
    isEnabled: isRasterActive,
    execute: () => dispatch("vravio-filter-repeat"),
  },
  {
    id: "filter.cameraRawFilter",
    label: { en: "Camera Raw Filter…", ru: "Фильтр Camera Raw…" },
    category: CATEGORY_FILTER,
    shortcut: "Mod+Shift+A",
    surfaces: ["menu", "palette"],
    isEnabled: isRasterActive,
    execute: () => dispatch("vravio-camera-raw-filter-open"),
  },
  {
