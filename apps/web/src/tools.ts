...
export const tools: readonly ToolDefinition[] = [
  ...
  { id: "raster.magicWand", kind: "raster", icon: "✦", iconFile: "ВОЛШЕБНАЯ ПАЛОЧКА.svg", label: { en: "Magic Wand Tool", ru: "Волшебная палочка" }, shortcut: "W", options: [{ id: "tolerance", label: { en: "Tolerance", ru: "Допуск" }, type: "number", min: 0, max: 255, step: 1, defaultValue: 32 }, { id: "loupe", label: { en: "Show loupe", ru: "Показывать лупу" }, type: "boolean", defaultValue: true }, { id: "allLayers", label: { en: "Sample all layers", ru: "Все слои" }, type: "boolean", defaultValue: true }] },
  ...
  { id: "raster.blur", kind: "raster", icon: "◌", iconFile: "РАЗМЫТИЕ.svg", label: { en: "Blur Tool", ru: "Размытие" }, shortcut: "R", options: [...brushTipOptions, { id: "strength", label: { en: "Strength", ru: "Интенсивность" }, type: "number", min: 1, max: 100, step: 1, defaultValue: 50, unit: "%" }] },
