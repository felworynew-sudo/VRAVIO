...
export const tools: readonly ToolDefinition[] = [
  ...
  { id: "raster.magicWand", kind: "raster", icon: "✦", iconFile: "ВОЛШЕБНАЯ ПАЛОЧКА.svg", label: "Magic Wand Tool (Волшебная палочка)", shortcut: "W", options: [{ id: "tolerance", label: "Tolerance (Допуск)", type: "number", min: 0, max: 255, step: 1, defaultValue: 32 }, { id: "loupe", label: "Show loupe (Показывать лупу)", type: "boolean", defaultValue: true }, { id: "allLayers", label: "Sample all layers (Все слои)", type: "boolean", defaultValue: true }] },
  ...
  { id: "raster.text", kind: "raster", icon: "T", iconFile: "ТЕКСТ.svg", label: "Type Tool (Текст)", shortcut: "T", options: [{ id: "textMode", label: "Mode (Режим)", type: "select", defaultValue: "auto", values: [{ value: "auto", label: "Point / Paragraph (Точечный / Блочный)" }, { value: "path", label: "Text on Path (Текст по контуру)" }, { value: "dynamicCircle", label: "Dynamic Circle (Динамический круг)" }, { value: "dynamicArch", label: "Dynamic Arch (Динамическая дуга)" }, { value: "dynamicBow", label: "Dynamic Bow (Динамический изгиб)" }] }, color, { id: "fontSize", label: "Font size (Размер шрифта)", type: "number", min: 1, max: 1000, step: 1, defaultValue: 48, unit: "px" }, { id: "fontFamily", label: "Font (Шрифт)", type: "select", defaultValue: "Arial", values: [{ value: "Arial", label: "Arial" }, { value: "Georgia", label: "Georgia" }, { value: "Verdana", label: "Verdana" }, { value: "monospace", label: "Monospace (Моноширинный)" }] }] },
  { id: "raster.shape", kind: "raster", icon: "▭", iconFile: "КВАДРАТ.svg", label: "Shape Tool (Фигура)", shortcut: "U", options: [{ id: "shapeKind", label: "Shape (Фигура)", type: "select", defaultValue: "rectangle", values: [{ value: "rectangle", label: "Rectangle (Прямоугольник)" }, { value: "roundedRectangle", label: "Rounded rectangle (Скруглённый прямоугольник)" }, { value: "ellipse", label: "Ellipse (Эллипс)" }, { value: "line", label: "Line (Линия)" }, { value: "triangle", label: "Triangle (Треугольник)" }, { value: "polygon", label: "Polygon (Многоугольник)" }, { value: "star", label: "Star (Звезда)" }] }, { id: "shapeMode", label: "Paint (Отрисовка)", type: "select", defaultValue: "fill", values: [{ value: "fill", label: "Fill (Заливка)" }, { value: "stroke", label: "Stroke (Обводка)" }, { value: "both", label: "Fill + stroke (Заливка и обводка)" }] }, color, { id: "strokeColor", label: "Stroke color (Цвет обводки)", type: "color", defaultValue: "#ffffff" }, { id: "strokeWidth", label: "Stroke width (Толщина обводки)", type: "number", min: 1, max: 200, step: 1, defaultValue: 4, unit: "px" }, { id: "cornerRadius", label: "Corner radius (Радиус скругления)", type: "number", min: 0, max: 400, step: 1, defaultValue: 16, unit: "px" }, { id: "sides", label: "Sides (Стороны)", type: "number", min: 3, max: 24, step: 1, defaultValue: 5 }] },
  { id: "raster.crop", kind: "raster", icon: "⌗", iconFile: "МОНТАЖ.svg", label: "Crop Tool (Рамка)", shortcut: "C", options: [] },
  { id: "raster.clone", kind: "raster", icon: "⧉", iconFile: "ШТАМП.svg", label: "Clone Tool (Штамп)", shortcut: "S", options: [...brushTipOptions, opacity, { id: "alignMode", label: "Alignment (Выравнивание)", type: "select", defaultValue: "registered", values: [{ value: "none", label: "None (Нет)" }, { value: "registered", label: "Registered (Совместное)" }, { value: "fixed", label: "Fixed (Фиксированное)" }] }] },
