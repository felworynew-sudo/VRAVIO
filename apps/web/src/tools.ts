...
export const tools: readonly ToolDefinition[] = [
  ...
  { id: "raster.selectionBrush", kind: "raster", icon: "◉", label: { en: "Selection Brush Tool", ru: "Кисть выделения" }, shortcut: "L", options: [...brushTipOptions.filter((option) => option.id !== "angle")] },
