 ...
 * `false` leaves every layer's own buffer intact and merely shifts its bounds,
 * including pixels left/above the new canvas, so content is still there if the
 * canvas is grown back later. A
