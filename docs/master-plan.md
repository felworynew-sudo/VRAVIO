...
- [ ] **1.** Клик по миниатюре маски, потом `Delete` — сейчас, судя по
      всему, удаляет не маску, а что-то другое/ничего; должен удалять
      именно маску (с обычным подтверждающим диалогом Photoshop —
      «Применить маску перед удалением?» / «Удалить» / «Отмена», если в
      проекте уже есть такой паттерн диалога для похожих действий —
      сверить перед реализацией).
