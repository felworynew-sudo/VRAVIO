...
- [x] **Advanced recording — punch-in и множественные дубли (8 сентября
      ...
      **Ключевое архитектурное решение**: `audio-commands.ts`'s
      ...
      punch-in.
      **Не сделано из всего этого захода**: автоматизация произвольных
      параметров эффектов (не только громкости дорожки) — единственный
      оставшийся пункт из списка Audacity-4, отложен явно, не молчаливо.
