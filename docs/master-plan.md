...
- [x] **Automation — громкость дорожки во времени (8 сентября 2026, тот
      ...
      **Не сделано из всего Audacity-4 этапа**: advanced recording
      (punch-in, множественные дубли), автоматизация произвольных
      параметров эффектов (не только громкости дорожки) — следующий
      заход. Plugin architecture — сделана отдельным заходом как
