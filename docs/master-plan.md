...
- [x] **Из Audacity 4 — realtime effect stack, ripple editing,
      ...
      **Не сделано из этого этапа**: plugin architecture, advanced
      recording (punch-in, множественные дубли), automation
      (параметрические кривые во времени) — следующий заход.
