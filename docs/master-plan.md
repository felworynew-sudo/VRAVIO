...
- [x] **5. Фильтры шума.** Был один шаг LCG по индексу байта; на индексах
      ...
      (это ±255, то есть сплошной снег). Осталось не сделанным и названо
      честно: переключатели Uniform/Gaussian и Monochromatic — модель
      параметров фильтра умеет только числовые ползунки.
