...
- [ ] **Apply Mask** — запечь маску в альфа-канал слоя и удалить саму
      маску; RGB-слой без альфы сначала становится RGBA. Донор: Patchy
      `Apply Layer Mask` (`pixels alpha × mask`, обёрнуто в Undo). У нас
      такой команды нет вообще.
